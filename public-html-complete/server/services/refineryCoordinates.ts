...
// This file contains accurate refinery coordinates for the main oil refineries worldwide
// These coordinates are based on real location data to correct the map display

type RefineryCoordinateData = {
  name: string;
  country: string;
  region: string;
  lat: number;
...
const MIDDLE_EAST_REFINERIES: RefineryCoordinateData[] = [
  {
...
const NORTH_AFRICA_REFINERIES: RefineryCoordinateData[] = [
  {
...
const WESTERN_EUROPE_REFINERIES: RefineryCoordinateData[] = [
  {
...
const EASTERN_EUROPE_REFINERIES: RefineryCoordinateData[] = [
  {
...
const NORTH_AMERICA_REFINERIES: RefineryCoordinateData[] = [
  {
...
const SOUTH_AMERICA_REFINERIES: RefineryCoordinateData[] = [
  {
...
const CENTRAL_AMERICA_REFINERIES: RefineryCoordinateData[] = [
  {
...
const SOUTHERN_AFRICA_REFINERIES: RefineryCoordinateData[] = [
  {
...
// Russia Refineries
const RUSSIA_REFINERIES: RefineryCoordinateData[] = [
  {
    name: "Omsk Refinery",
    country: "Russia",
    region: "russia",
...
// China Refineries
const CHINA_REFINERIES: RefineryCoordinateData[] = [
  {
...
const ASIA_PACIFIC_REFINERIES: RefineryCoordinateData[] = [
  {
...
const SOUTHEAST_ASIA_OCEANIA_REFINERIES: RefineryCoordinateData[] = [
  {
...
export const ACCURATE_REFINERIES: RefineryCoordinateData[] = [
...
// Convert to InsertRefinery type
export function getAccurateRefineries(): InsertRefinery[] {
  return ACCURATE_REFINERIES.map(refinery => ({
    name: refinery.name,
