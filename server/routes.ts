...
9. Make it look like a real professional maritime business document`;
  ...
  apiRouter.get("/download-document/:id", async (req: Request, res) => {
    try {
      ...
      if (format === 'pdf') {
        // Simple PDF Template - Fill data into clean format
        ...
        // SIMPLE TEMPLATE APPROACH - Clean and Professional
        
        // Header Section
        doc.rect(0, 0, doc.page.width, 60)
           .fill('#1e40af');
        
        // Company Logo (Simple Circle)
        doc.circle(35, 30, 15)
           .fill('white');
        ...
        doc.fontSize(20)
           .fillColor('white')
           .text('PETRODEALHUB', 60, 20);
        
        // Document Title
        doc.fontSize(18)
           .fillColor('#1e40af')
           .text(document.title, 72, 100);
        
        // Vessel Information Box
        doc.rect(72, 140, doc.page.width - 144, 60)
           .stroke('#e5e7eb')
           .fill('#f8fafc');
        
        doc.fontSize(12)
           .fillColor('#1e40af')
           .text(`Vessel: ${vessel.name}`, 85, 155);
        
        doc.fontSize(10)
           .fillColor('#6b7280')
           .text(`IMO: ${vessel.imo || 'N/A'} | Flag: ${vessel.flag || 'N/A'}`, 85, 175);
        ...
        // Footer - Your Legal Text
        const footerY = doc.page.height - 80;
        
        doc.rect(72, footerY, doc.page.width - 144, 60)
           .fill('#f9fafb')
           .stroke('#e5e7eb');
