...
9. Make it look like a real professional maritime business document`;
  ...
  apiRouter.get("/download-document/:id", async (req: Request, res) => {
    try {
      ...
      if (format === 'pdf') {
        // Use your exact template background with AI content overlay
        ...
        // Your exact template design
        // Top Left: "LEGAL DOCUMENT SERVICES"
        doc.fontSize(14)
           .fillColor('#000000')
           .font('Helvetica-Bold')
        ...
        // Footer with fingerprint and legal text
