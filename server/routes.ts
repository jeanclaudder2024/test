      ...
      const plans = [
        {
          ...
          isPopular: false,
          features: [
            "Access to 2 marine zones",
            "Track up to 250 tankers",
            "Up to 25 refineries",
            "5 major ports",
            "LOI, B/L documentation only",
            "View-only deal access",
            "1 user",
            "Email support only",
        ...
        },
        {
          ...
          features: [
            ...
            "Full access including internal documentation (gate passes)",
            ...
            "International Broker ID included with official registration",
