-- CORRECT BROKER DATABASE SCHEMA FOR SUPABASE
-- Copy and paste this entire script into your Supabase SQL Editor
-- This matches the exact schema used by the application
...
-- ========================================
-- 2. BROKER DEALS TABLE (Matches application schema)
-- ========================================
CREATE TABLE IF NOT EXISTS broker_deals (
  ...
  -- Status columns (both for compatibility)
...
-- ========================================
-- SYNC STATUS COLUMNS (Important Fix)
-- ========================================
...
SELECT 
    table_name,
    CASE 
        WHEN table_name = 'broker_card_applications' THEN '✓ Card Applications'
        WHEN table_name = 'broker_deals' THEN '✓ Broker Deals'
        WHEN table_name = 'transaction_steps' THEN '✓ Transaction Steps'
        WHEN table_name = 'transaction_documents' THEN '✓ Transaction Documents'
        WHEN table_name = 'deal_messages' THEN '✓ Deal Messages'
        WHEN table_name = 'broker_documents' THEN '✓ Broker Documents'
        WHEN table_name = 'broker_admin_files' THEN '✓ Admin Files'
        WHEN table_name = 'broker_stats' THEN '✓ Broker Stats'
        WHEN table_name = 'broker_profiles' THEN '✓ Broker Profiles'
        ELSE table_name
    END as status
