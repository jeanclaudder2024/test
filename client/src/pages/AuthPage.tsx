...
export default function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-[#001f3f] to-[#003366] dark:from-[#001a33] dark:to-[#002b4d]">
      {/* Navigation */}
      <header className="px-4 lg:px-6 h-40 flex items-center justify-between border-b border-orange-500/20 backdrop-blur-sm bg-background/50 dark:bg-slate-900/80 fixed w-full z-50">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 items-center pt-40">
        {/* Auth Form Column */}
