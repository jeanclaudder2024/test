  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-orange-50">
      ...
      <main className="pt-20">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-orange-600 bg-clip-text text-transparent mb-6">
                📚 Documentation Center
              </h1>
              <p className="text-xl md:text-2xl text-slate-600 mb-8 max-w-4xl mx-auto leading-relaxed">
                Professional Resources to Empower Global Oil Transactions
              </p>
              <p className="text-lg text-slate-700 max-w-5xl mx-auto leading-relaxed">
        ...
        {/* Important Notice */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-orange-50">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 border border-blue-200 shadow-xl">
                <div className="flex items-start space-x-4">
                  <AlertTriangle className="h-8 w-8 text-amber-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-2xl font-bold text-slate-800 mb-4">Important Notice</h3>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              {features.map((feature, index) => (
                ...
                >
                  <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                    <div className="flex flex-col items-center text-center">
                      {feature.icon}
                      <h3 className="text-lg font-bold text-slate-800 mt-4 mb-2">{feature.title}</h3>
            ...
            <motion.div
              id="help-text"
              data-animate
              className={`text-center bg-gradient-to-r from-blue-50 to-orange-50 rounded-2xl p-8 transform transition-all duration-1000 delay-800 ${
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {documentCategories.map((category, index) => (
                ...
                >
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group">
                    ...
                    <h3 className="text-lg font-bold text-slate-800 mb-3">{category.title}</h3>
            ...
            <motion.div
              id="note"
              data-animate
              className={`mt-12 bg-amber-50 border border-amber-200 rounded-2xl p-6 transform transition-all duration-1000 delay-1000 ${
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <motion.div
                  ...
                  id={`reason-${index}`}
                  data-animate
                  className={`flex items-start space-x-4 p-6 bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200 shadow-lg transform transition-all duration-1000 ${
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-red-50 to-orange-50">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent mb-8">
                🔐 Confidentiality & Usage Policy
              </h2>
            </motion.div>
            ...
            <div className="space-y-6">
              {[
                ...
                <motion.div
                  ...
                  id={`policy-${index}`}
                  data-animate
                  className={`flex items-start space-x-4 p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-red-200 shadow-lg transform transition-all duration-1000 ${
                  ...
                  style={{ transitionDelay: `${400 + index * 150}ms` }}
                >
                  <Lock className="h-6 w-6 text-red-500 mt-0.5 flex-shrink-0" />
                  <p className="text-slate-700 leading-relaxed">{policy}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-slate-600">Our documentation resources are best suited for:</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {targetAudience.map((audience, index) => (
                <motion.div
                  ...
                  id={`audience-${index}`}
                  data-animate
                  className={`text-center p-6 bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 transform ${
                  ...
                  style={{ transitionDelay: `${400 + index * 100}ms` }}
                >
                  <div className="inline-flex items-center justify-center p-3 bg-gradient-to-r from-blue-50 to-orange-50 rounded-xl mb-4">
                    {audience.icon}
                  </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-purple-50">
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              ...
              <div className="inline-flex items-center space-x-3 bg-white/80 backdrop-blur-sm rounded-full px-8 py-4 border border-blue-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <Mail className="h-6 w-6 text-blue-500" />
                <span className="text-lg font-semibold text-slate-800">Contact: documentation@petrodealhub.com</span>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h3 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-orange-600 bg-clip-text text-transparent mb-6">
