...
import { Eye, EyeOff, Mail, Lock, User, Building, ArrowRight, CheckCircle, Globe, TrendingUp } from "lucide-react";
        ...
        >
          <div className="space-y-6">
            ...
            <p className="text-xl text-white/70 leading-relaxed">
              Connect with global traders, access real-time market data, 
              and streamline your petroleum operations from day one.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10">
                ...
                <p className="text-sm text-white/70">Access to 50+ countries and 2,500+ active vessels</p>
              </div>
              
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10">
                <div className="flex items-center space-x-3 mb-2">
                  <TrendingUp className="h-5 w-5 text-orange-400" />
                  <span className="font-semibold text-white">Real-time Data</span>
                </div>
                <p className="text-sm text-white/70">Live market prices and vessel tracking</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white/80">Free 14-day trial with full platform access</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0" />
                <span className="text-white/80">24/7 customer support and onboarding</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0" />
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    <Checkbox 
                      ...
                      className="mt-1 border-white/20 data-[state=checked]:bg-orange-500 data-[state=checked]:border-orange-500"
                    />
                    <Label htmlFor="marketing" className="text-sm text-white/80 leading-relaxed">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-slate-800 px-2 text-white/60">Or sign up with</span>
                </div>
              </div>
