...
SELECT id, 'Global Maritime Energy Corp' FROM real_companies WHERE name = 'Chevron Corporation'
UNION ALL
SELECT id, 'Pacific Oil Trading Solutions' FROM real_companies WHERE name = 'Chevron Corporation'
UNION ALL
SELECT id, 'International Petroleum Holdings' FROM real_companies WHERE name = 'ExxonMobil Corporation'
UNION ALL
SELECT id, 'Northern Energy Logistics Ltd' FROM real_companies WHERE name = 'ExxonMobil Corporation'
UNION ALL
SELECT id, 'Atlantic Oil Transport Group' FROM real_companies WHERE name = 'Shell plc'
UNION ALL
SELECT id, 'Maritime Energy Partners' FROM real_companies WHERE name = 'Shell plc'
UNION ALL
SELECT id, 'Western Oil Trading Systems' FROM real_companies WHERE name = 'TotalEnergies SE'
UNION ALL
SELECT id, 'Global Energy Solutions Corp' FROM real_companies WHERE name = 'TotalEnergies SE'
UNION ALL
SELECT id, 'Eastern Maritime Oil Ltd' FROM real_companies WHERE name = 'BP plc'
UNION ALL
SELECT id, 'International Trading Enterprises' FROM real_companies WHERE name = 'BP plc'
