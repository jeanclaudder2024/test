-- Complete Document Templates Database Setup
-- Run this SQL in your Supabase database

-- Step 1: Create the document_templates table
CREATE TABLE IF NOT EXISTS document_templates (
  id SERIAL PRIMARY KEY,
  name VARCHAR(255) NOT NULL,
  description TEXT NOT NULL,
  category VARCHAR(50) NOT NULL CHECK (category IN ('technical', 'commercial', 'inspection', 'cargo', 'environmental', 'regulatory', 'operations', 'performance', 'insurance', 'crew', 'safety', 'maintenance')),
...
-- Step 2: Create the generated_documents table  
...
-- Step 4: Insert 15 Comprehensive Maritime Document Templates
...
SELECT name, category, usage_count FROM document_templates ORDER BY category, name;